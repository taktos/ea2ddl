...
/**
 * The condition-inline-query of t_objectfiles.
 * @author DBFlute(AutoGenerator)
 */
public class TObjectfilesCIQ extends AbstractBsTObjectfilesCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTObjectfilesCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TObjectfilesCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTObjectfilesCQ myCQ) {
    ...
    String xiCB() { return TObjectfilesCB.class.getName(); }
    String xiCQ() { return TObjectfilesCQ.class.getName(); }
}
