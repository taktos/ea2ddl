...
/**
 * The condition-inline-query of t_attributetag.
 * @author DBFlute(AutoGenerator)
 */
public class TAttributetagCIQ extends AbstractBsTAttributetagCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTAttributetagCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TAttributetagCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTAttributetagCQ myCQ) {
    ...
    String xiCB() { return TAttributetagCB.class.getName(); }
    String xiCQ() { return TAttributetagCQ.class.getName(); }
}
