...
/**
 * The condition-inline-query of t_connectortag.
 * @author DBFlute(AutoGenerator)
 */
public class TConnectortagCIQ extends AbstractBsTConnectortagCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTConnectortagCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TConnectortagCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTConnectortagCQ myCQ) {
    ...
    String xiCB() { return TConnectortagCB.class.getName(); }
    String xiCQ() { return TConnectortagCQ.class.getName(); }
}
