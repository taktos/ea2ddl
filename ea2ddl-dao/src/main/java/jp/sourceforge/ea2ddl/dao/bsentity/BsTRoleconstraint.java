...
public abstract class BsTRoleconstraint implements Entity, Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTRoleconstraint)) { return false; }
        final BsTRoleconstraint otherEntity = (BsTRoleconstraint)other;
        ...
        if (!helpComparingValue(getConnectorend(), otherEntity.getConnectorend())) { return false; }
    ...
    public int hashCode() {
        ...
        if (this.getConnectorend() != null) { result = result + this.getConnectorend().hashCode(); }
    ...
    public String toString() {
        ...
        sb.append(delimiter).append(getConnectorend());
    ...
    public void setConnectorend(String connectorend) {
        _modifiedProperties.addPropertyName("connectorend");
