...
/**
 * The condition-inline-query of t_resources.
 * @author DBFlute(AutoGenerator)
 */
public class TResourcesCIQ extends AbstractBsTResourcesCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTResourcesCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TResourcesCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTResourcesCQ myCQ) {
    ...
    String xiCB() { return TResourcesCB.class.getName(); }
    String xiCQ() { return TResourcesCQ.class.getName(); }
}
