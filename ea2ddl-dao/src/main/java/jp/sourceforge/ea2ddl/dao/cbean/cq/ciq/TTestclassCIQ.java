...
/**
 * The condition-inline-query of t_testclass.
 * @author DBFlute(AutoGenerator)
 */
@SuppressWarnings("unchecked")
public class TTestclassCIQ extends AbstractBsTTestclassCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTTestclassCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TTestclassCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTTestclassCQ myCQ) {
