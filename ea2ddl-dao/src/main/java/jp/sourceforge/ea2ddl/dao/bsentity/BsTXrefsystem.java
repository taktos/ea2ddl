...
/**
 * The entity of t_xrefsystem(TABLE).
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsTXrefsystem implements Entity, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is t_xrefsystem. */
    public static final String TABLE = "t_xrefsystem";
