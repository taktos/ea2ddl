...
public class InternalProcedureMetaDataFactory {
    ...
    //                                                                                Main
    //                                                                                ====
    public InternalProcedureMetaData createProcedureMetaData(final String procedureName, final Class<?> pmbType) {
        final InternalProcedureMetaData metaData = new InternalProcedureMetaData(procedureName);
        if (pmbType == null) {
            return metaData;
        } else {
    ...
    protected void registerParameterType(InternalProcedureMetaData metaData, BeanDesc pmbDesc, Field[] fields) {
        for (Field field : fields) {
            ...
            final InternalProcedureParameterType ppt = getProcedureParameterType(pmbDesc, field);
            if (ppt == null) {
                continue;
            }
    ...
    protected InternalProcedureParameterType getProcedureParameterType(final BeanDesc dtoDesc, final Field field) {
        ...
        final InternalProcedureParameterType ppt = new InternalProcedureParameterType(field);
