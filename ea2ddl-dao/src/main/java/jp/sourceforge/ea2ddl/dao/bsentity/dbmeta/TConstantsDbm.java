...
public class TConstantsDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected ColumnInfo _columnConstantname = cci("ConstantName", "constantname", String.class, false, 50, 0);
    protected ColumnInfo _columnConstantvalue = cci("ConstantValue", "constantvalue", String.class, false, 255, 0);
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected Map<String, Eps<TConstants>> _epsMap = newHashMap();
    {
