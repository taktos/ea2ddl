...
public abstract class BsTHtml implements Entity, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is t_html. */
    public static final String TABLE = "t_html";
