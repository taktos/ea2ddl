...
public class TCategoryDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected ColumnInfo _columnCategoryid = cci("CategoryID", "categoryid", java.lang.Integer.class, false, null, null);
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected Map<String, Eps<TCategory>> _epsMap = newHashMap();
    {
