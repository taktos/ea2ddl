...
public class TConnectorconstraintCQ extends BsTConnectorconstraintCQ {
     ...
     */
    public TConnectorconstraintCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
