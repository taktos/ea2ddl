...
/**
 * The condition-inline-query of t_xref.
 * @author DBFlute(AutoGenerator)
 */
public class TXrefCIQ extends AbstractBsTXrefCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsTXrefCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public TXrefCIQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel, BsTXrefCQ myCQ) {
    ...
    String xiCB() { return TXrefCB.class.getName(); }
    String xiCQ() { return TXrefCQ.class.getName(); }
}
