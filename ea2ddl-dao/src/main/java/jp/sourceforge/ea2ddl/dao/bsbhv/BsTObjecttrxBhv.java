 ...
 */
public abstract class BsTObjecttrxBhv extends jp.sourceforge.ea2ddl.dao.allcommon.bhv.AbstractBehaviorReadable {
    ...
    //                                                                        Dao Accessor
    //                                                                        ============
    public TObjecttrxDao getMyDao() { return _dao; }
    public void setMyDao(TObjecttrxDao dao) { assertObjectNotNull("dao", dao); _dao = dao; }
    ...
    public ListResultBean<TObjecttrx> selectList(TObjecttrxCB cb) {
        assertConditionBeanNotNull(cb);
        return new jp.sourceforge.ea2ddl.dao.allcommon.cbean.ResultBeanBuilder<TObjecttrx>(getTableDbName()).buildListResultBean(cb, delegateSelectList(cb));
    }
     ...
     */
    public List<java.util.Map<String, Object>> selectValueLabelList(TObjecttrxCB cb, ValueLabelSetupper<TObjecttrx> valueLabelSetupper) {
    ...
    //                                                Select
    //                                                ------
    protected int delegateSelectCount(TObjecttrxCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectCount(cb); }
    protected List<TObjecttrx> delegateSelectList(TObjecttrxCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectList(cb); }
