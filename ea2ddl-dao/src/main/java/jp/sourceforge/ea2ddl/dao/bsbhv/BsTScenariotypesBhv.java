...
/**
 * The behavior of t_scenariotypes.
 * <pre>
 * [primary-key]
 *     
 * 
 ...
 */
public abstract class BsTScenariotypesBhv extends jp.sourceforge.ea2ddl.dao.allcommon.bhv.AbstractBehaviorReadable {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected TScenariotypesDao _dao;
    ...
    //                                                                        Dao Accessor
    //                                                                        ============
    public TScenariotypesDao getMyDao() { return _dao; }
    public void setMyDao(TScenariotypesDao dao) { assertObjectNotNull("dao", dao); _dao = dao; }
    ...
    public ListResultBean<TScenariotypes> selectList(TScenariotypesCB cb) {
        assertConditionBeanNotNull(cb);
        return new jp.sourceforge.ea2ddl.dao.allcommon.cbean.ResultBeanBuilder<TScenariotypes>(getTableDbName()).buildListResultBean(cb, delegateSelectList(cb));
    }
     ...
     */
    public List<java.util.Map<String, Object>> selectValueLabelList(TScenariotypesCB cb, ValueLabelSetupper<TScenariotypes> valueLabelSetupper) {
    ...
    //                                                Select
    //                                                ------
    protected int delegateSelectCount(TScenariotypesCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectCount(cb); }
    protected List<TScenariotypes> delegateSelectList(TScenariotypesCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectList(cb); }
