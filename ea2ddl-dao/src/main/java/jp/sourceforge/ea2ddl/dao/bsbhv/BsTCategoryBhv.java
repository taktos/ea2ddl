 ...
 */
public abstract class BsTCategoryBhv extends jp.sourceforge.ea2ddl.dao.allcommon.bhv.AbstractBehaviorReadable {
    ...
    //                                                                        Dao Accessor
    //                                                                        ============
    public TCategoryDao getMyDao() { return _dao; }
    public void setMyDao(TCategoryDao dao) { assertObjectNotNull("dao", dao); _dao = dao; }
    ...
    public ListResultBean<TCategory> selectList(TCategoryCB cb) {
        assertConditionBeanNotNull(cb);
        return new jp.sourceforge.ea2ddl.dao.allcommon.cbean.ResultBeanBuilder<TCategory>(getTableDbName()).buildListResultBean(cb, delegateSelectList(cb));
    }
     ...
     */
    public List<java.util.Map<String, Object>> selectValueLabelList(TCategoryCB cb, ValueLabelSetupper<TCategory> valueLabelSetupper) {
    ...
    //                                                Select
    //                                                ------
    protected int delegateSelectCount(TCategoryCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectCount(cb); }
    protected List<TCategory> delegateSelectList(TCategoryCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectList(cb); }
