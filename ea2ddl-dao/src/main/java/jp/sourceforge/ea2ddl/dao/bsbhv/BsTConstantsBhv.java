 ...
 */
public abstract class BsTConstantsBhv extends jp.sourceforge.ea2ddl.dao.allcommon.bhv.AbstractBehaviorReadable {
    ...
    //                                                                        Dao Accessor
    //                                                                        ============
    public TConstantsDao getMyDao() { return _dao; }
    public void setMyDao(TConstantsDao dao) { assertObjectNotNull("dao", dao); _dao = dao; }
    ...
    public ListResultBean<TConstants> selectList(TConstantsCB cb) {
        assertConditionBeanNotNull(cb);
        return new jp.sourceforge.ea2ddl.dao.allcommon.cbean.ResultBeanBuilder<TConstants>(getTableDbName()).buildListResultBean(cb, delegateSelectList(cb));
    }
     ...
     */
    public List<java.util.Map<String, Object>> selectValueLabelList(TConstantsCB cb, ValueLabelSetupper<TConstants> valueLabelSetupper) {
    ...
    //                                                Select
    //                                                ------
    protected int delegateSelectCount(TConstantsCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectCount(cb); }
    protected List<TConstants> delegateSelectList(TConstantsCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectList(cb); }
