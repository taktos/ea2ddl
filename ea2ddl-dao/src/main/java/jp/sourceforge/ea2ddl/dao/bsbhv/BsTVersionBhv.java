 ...
 */
public abstract class BsTVersionBhv extends jp.sourceforge.ea2ddl.dao.allcommon.bhv.AbstractBehaviorReadable {
    ...
    //                                                                        Dao Accessor
    //                                                                        ============
    public TVersionDao getMyDao() { return _dao; }
    public void setMyDao(TVersionDao dao) { assertObjectNotNull("dao", dao); _dao = dao; }
    ...
    public ListResultBean<TVersion> selectList(TVersionCB cb) {
        assertConditionBeanNotNull(cb);
        return new jp.sourceforge.ea2ddl.dao.allcommon.cbean.ResultBeanBuilder<TVersion>(getTableDbName()).buildListResultBean(cb, delegateSelectList(cb));
    }
     ...
     */
    public List<java.util.Map<String, Object>> selectValueLabelList(TVersionCB cb, ValueLabelSetupper<TVersion> valueLabelSetupper) {
    ...
    //                                                Select
    //                                                ------
    protected int delegateSelectCount(TVersionCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectCount(cb); }
    protected List<TVersion> delegateSelectList(TVersionCB cb) { assertConditionBeanNotNull(cb); return getMyDao().selectList(cb); }
