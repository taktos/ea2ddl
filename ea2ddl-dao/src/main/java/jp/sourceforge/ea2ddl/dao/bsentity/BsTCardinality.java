...
/**
 * The entity of t_cardinality(TABLE).
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsTCardinality implements Entity, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is t_cardinality. */
    public static final String TABLE = "t_cardinality";
    ...
    //                                                Column
    //                                                ------
    /** The attribute of the column 'Cardinality'. {UQ : VARCHAR(50)} */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTCardinality)) { return false; }
        final BsTCardinality otherEntity = (BsTCardinality)other;
