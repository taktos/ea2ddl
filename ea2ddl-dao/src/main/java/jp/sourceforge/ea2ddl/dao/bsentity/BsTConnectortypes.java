...
/**
 * The entity of t_connectortypes(TABLE).
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsTConnectortypes implements Entity, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is t_connectortypes. */
    public static final String TABLE = "t_connectortypes";
    ...
    //                                                Column
    //                                                ------
    /** The attribute of the column 'Connector_Type'. {UQ : VARCHAR(50)} */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTConnectortypes)) { return false; }
        final BsTConnectortypes otherEntity = (BsTConnectortypes)other;
