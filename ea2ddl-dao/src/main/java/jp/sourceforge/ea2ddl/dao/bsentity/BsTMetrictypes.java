...
/**
 * The entity of t_metrictypes(TABLE).
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsTMetrictypes implements Entity, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is t_metrictypes. */
    public static final String TABLE = "t_metrictypes";
    ...
    //                                                Column
    //                                                ------
    /** The attribute of the column 'Metric'. {UQ : VARCHAR(12)} */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTMetrictypes)) { return false; }
        final BsTMetrictypes otherEntity = (BsTMetrictypes)other;
