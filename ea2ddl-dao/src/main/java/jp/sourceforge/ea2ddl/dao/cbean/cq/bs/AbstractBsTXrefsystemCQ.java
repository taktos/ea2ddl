...
/**
 * The abstract condition-query of t_xrefsystem.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsTXrefsystemCQ extends AbstractConditionQuery {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTXrefsystemCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    public void setToolid_LikeSearch(String toolid, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(toolid), getCValueToolid(), "ToolID", likeSearchOption);
    }

    /**
     * NotLikeSearch(not like 'xxx%' escape ...). And NullOrEmptyIgnored, SeveralRegistered.
     * @param toolid The value of toolid as notLikeSearch.
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    public void setToolid_NotLikeSearch(String toolid, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(toolid), getCValueToolid(), "ToolID", likeSearchOption);
    }

    /**
     * IsNull(is null). And OnlyOnceRegistered.
     */
    public void setToolid_IsNull() { regToolid(CK_ISN, DOBJ); }

    /**
     * IsNotNull(is not null). And OnlyOnceRegistered.
     */
    public void setToolid_IsNotNull() { regToolid(CK_ISNN, DOBJ); }

    protected void regToolid(ConditionKey k, Object v) { regQ(k, v, getCValueToolid(), "ToolID"); }
    ...
    String xCB() { return TXrefsystemCB.class.getName(); }
    String xCQ() { return TXrefsystemCQ.class.getName(); }
