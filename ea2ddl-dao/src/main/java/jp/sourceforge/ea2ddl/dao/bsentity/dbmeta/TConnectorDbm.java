...
public class TConnectorDbm extends AbstractDBMeta {
    ...
    protected ColumnInfo _columnSubtype = cci("SubType", "subtype", String.class, false, 50, 0);
    protected ColumnInfo _columnSourcecard = cci("SourceCard", "sourcecard", String.class, false, 50, 0);
    protected ColumnInfo _columnSourceaccess = cci("SourceAccess", "sourceaccess", String.class, false, 50, 0);
    protected ColumnInfo _columnSourceelement = cci("SourceElement", "sourceelement", String.class, false, 50, 0);
    protected ColumnInfo _columnDestcard = cci("DestCard", "destcard", String.class, false, 50, 0);
    protected ColumnInfo _columnDestaccess = cci("DestAccess", "destaccess", String.class, false, 50, 0);
    protected ColumnInfo _columnDestelement = cci("DestElement", "destelement", String.class, false, 50, 0);
    protected ColumnInfo _columnSourcerole = cci("SourceRole", "sourcerole", String.class, false, 255, 0);
    protected ColumnInfo _columnSourceroletype = cci("SourceRoleType", "sourceroletype", String.class, false, 50, 0);
    protected ColumnInfo _columnSourcerolenote = cci("SourceRoleNote", "sourcerolenote", String.class, false, 2147483647, 0);
    protected ColumnInfo _columnSourcecontainment = cci("SourceContainment", "sourcecontainment", String.class, false, 50, 0);
    protected ColumnInfo _columnSourceisaggregate = cci("SourceIsAggregate", "sourceisaggregate", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnSourceisordered = cci("SourceIsOrdered", "sourceisordered", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnSourcequalifier = cci("SourceQualifier", "sourcequalifier", String.class, false, 50, 0);
    protected ColumnInfo _columnDestrole = cci("DestRole", "destrole", String.class, false, 255, 0);
    protected ColumnInfo _columnDestroletype = cci("DestRoleType", "destroletype", String.class, false, 50, 0);
    protected ColumnInfo _columnDestrolenote = cci("DestRoleNote", "destrolenote", String.class, false, 2147483647, 0);
    protected ColumnInfo _columnDestcontainment = cci("DestContainment", "destcontainment", String.class, false, 50, 0);
    protected ColumnInfo _columnDestisaggregate = cci("DestIsAggregate", "destisaggregate", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnDestisordered = cci("DestIsOrdered", "destisordered", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnDestqualifier = cci("DestQualifier", "destqualifier", String.class, false, 50, 0);
    protected ColumnInfo _columnStartObjectId = cci("Start_Object_ID", "startObjectId", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnEndObjectId = cci("End_Object_ID", "endObjectId", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnTopStartLabel = cci("Top_Start_Label", "topStartLabel", String.class, false, 50, 0);
    protected ColumnInfo _columnTopMidLabel = cci("Top_Mid_Label", "topMidLabel", String.class, false, 50, 0);
    protected ColumnInfo _columnTopEndLabel = cci("Top_End_Label", "topEndLabel", String.class, false, 50, 0);
    protected ColumnInfo _columnBtmStartLabel = cci("Btm_Start_Label", "btmStartLabel", String.class, false, 50, 0);
    protected ColumnInfo _columnBtmMidLabel = cci("Btm_Mid_Label", "btmMidLabel", String.class, false, 50, 0);
    protected ColumnInfo _columnBtmEndLabel = cci("Btm_End_Label", "btmEndLabel", String.class, false, 50, 0);
    protected ColumnInfo _columnStartEdge = cci("Start_Edge", "startEdge", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnEndEdge = cci("End_Edge", "endEdge", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnPtstartx = cci("PtStartX", "ptstartx", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnPtstarty = cci("PtStartY", "ptstarty", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnPtendx = cci("PtEndX", "ptendx", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnPtendy = cci("PtEndY", "ptendy", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnSeqno = cci("SeqNo", "seqno", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnHeadstyle = cci("HeadStyle", "headstyle", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnLinestyle = cci("LineStyle", "linestyle", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnRoutestyle = cci("RouteStyle", "routestyle", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnIsbold = cci("IsBold", "isbold", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnLinecolor = cci("LineColor", "linecolor", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnStereotype = cci("Stereotype", "stereotype", String.class, false, 50, 0);
    protected ColumnInfo _columnVirtualinheritance = cci("VirtualInheritance", "virtualinheritance", String.class, false, 1, 0);
    protected ColumnInfo _columnLinkaccess = cci("LinkAccess", "linkaccess", String.class, false, 50, 0);
    ...
    protected ColumnInfo _columnSourceconstraint = cci("SourceConstraint", "sourceconstraint", String.class, false, 255, 0);
    protected ColumnInfo _columnDestconstraint = cci("DestConstraint", "destconstraint", String.class, false, 255, 0);
    protected ColumnInfo _columnSourceisnavigable = cci("SourceIsNavigable", "sourceisnavigable", Boolean.class, false, null, null);
    protected ColumnInfo _columnDestisnavigable = cci("DestIsNavigable", "destisnavigable", Boolean.class, false, null, null);
    ...
    protected ColumnInfo _columnSourcechangeable = cci("SourceChangeable", "sourcechangeable", String.class, false, 12, 0);
    protected ColumnInfo _columnDestchangeable = cci("DestChangeable", "destchangeable", String.class, false, 12, 0);
    protected ColumnInfo _columnSourcets = cci("SourceTS", "sourcets", String.class, false, 12, 0);
    protected ColumnInfo _columnDestts = cci("DestTS", "destts", String.class, false, 12, 0);
    ...
    protected ColumnInfo _columnIssignal = cci("IsSignal", "issignal", Boolean.class, false, null, null);
    protected ColumnInfo _columnIsstimulus = cci("IsStimulus", "isstimulus", Boolean.class, false, null, null);
    protected ColumnInfo _columnDispatchaction = cci("DispatchAction", "dispatchaction", String.class, false, 255, 0);
    protected ColumnInfo _columnTarget2 = cci("Target2", "target2", java.lang.Integer.class, false, null, null);
    protected ColumnInfo _columnStyleex = cci("StyleEx", "styleex", String.class, false, 2147483647, 0);
    protected ColumnInfo _columnSourcestereotype = cci("SourceStereotype", "sourcestereotype", String.class, false, 255, 0);
    protected ColumnInfo _columnDeststereotype = cci("DestStereotype", "deststereotype", String.class, false, 255, 0);
    protected ColumnInfo _columnSourcestyle = cci("SourceStyle", "sourcestyle", String.class, false, 2147483647, 0);
    protected ColumnInfo _columnDeststyle = cci("DestStyle", "deststyle", String.class, false, 2147483647, 0);
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected Map<String, Eps<TConnector>> _epsMap = newHashMap();
    {
