...
/**
 * The entity of t_operationtag(TABLE).
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsTOperationtag implements Entity, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is t_operationtag. */
    public static final String TABLE = "t_operationtag";
