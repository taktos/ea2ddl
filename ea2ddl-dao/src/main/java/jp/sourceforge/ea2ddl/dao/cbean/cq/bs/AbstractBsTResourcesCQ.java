...
/**
 * The abstract condition-query of t_resources.
 * @author DBFlute(AutoGenerator)
 */
@SuppressWarnings("unchecked")
public abstract class AbstractBsTResourcesCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsTResourcesCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
