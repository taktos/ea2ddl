...
public class TProblemtypesDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected ColumnInfo _columnProblemtype = cci("ProblemType", null, "problemtype", String.class, false, false, 12, 0);
    ...
    //                                                               =====================
    // It's very INTERNAL!
    protected Map<String, Eps<TProblemtypes>> _epsMap = StringKeyMap.createAsFlexibleConcurrent();
    {
