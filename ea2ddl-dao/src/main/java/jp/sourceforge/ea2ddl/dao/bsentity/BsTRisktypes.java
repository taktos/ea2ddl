...
/**
 * The entity of t_risktypes(TABLE).
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsTRisktypes implements Entity, java.io.Serializable {
    ...
    /** TABLE-Annotation for S2Dao. The value is t_risktypes. */
    public static final String TABLE = "t_risktypes";
    ...
    //                                                Column
    //                                                ------
    /** The attribute of the column 'Risk'. {UQ : VARCHAR(12)} */
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsTRisktypes)) { return false; }
        final BsTRisktypes otherEntity = (BsTRisktypes)other;
